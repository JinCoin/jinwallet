...
Package walletdb provides a namespaced database interface for jinwallet.
...
[![GoDoc](https://godoc.org/github.com/JinCoin/jinwallet/walletdb?status.png)]
(http://godoc.org/github.com/JinCoin/jinwallet/walletdb)
...
http://localhost:6060/pkg/github.com/JinCoin/jinwallet/walletdb

## Installation

```bash
$ go get github.com/JinCoin/jinwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/JinCoin/jinwallet/walletdb#example-package--BasicUsage)  
