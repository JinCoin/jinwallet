...
var helpDescsEnUS = map[string]string{
	...
	"getbalance--result0":    "The balance of 'account' valued in jincoin",
	"getbalance--result1":    "The balance of all accounts valued in jincoin",
	...
	"getreceivedbyaccount--result0":  "The total received amount valued in jincoin",
	...
	"getreceivedbyaddress--result0":  "The total received amount valued in jincoin",
	...
	"gettransactionresult-amount":          "The total amount this transaction credits to the wallet, valued in jincoin",
	...
	"listaccounts--result0--desc":  "JSON object with account names as keys and jincoin amounts as values",
	"listaccounts--result0--key":   "The account name",
	"listaccounts--result0--value": "The account balance valued in jincoin",
	...
	"listreceivedbyaccountresult-amount":        "Total amount received by payment addresses of the account valued in jincoin",
	...
	"listreceivedbyaddressresult-amount":            "Total amount received by the payment address valued in jincoin",
	...
	"listtransactionsresult-amount":            "The value of the transaction output valued in jincoin",
	...
	"listunspentresult-amount":        "The amount of the output valued in jincoin",
	...
	"sendfrom-amount":      "Amount to send to the payment address valued in jincoin",
	...
	"sendmany-amounts--desc":  "JSON object using payment addresses as keys and output amounts valued in jincoin to send to each address",
	"sendmany-amounts--key":   "Address to pay",
	"sendmany-amounts--value": "Amount to send to the payment address valued in jincoin",
	...
	"sendtoaddress-amount":    "Amount to send to the payment address valued in jincoin",
	...
	"settxfee-amount":    "The new fee increment valued in jincoin",
	...
	"getunconfirmedbalance--result0":  "Total amount of all unmined unspent outputs of the account valued in jincoin.",
