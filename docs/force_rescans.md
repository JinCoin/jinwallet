...
jinwallet will not drop transaction history by itself, as this is something that
...
```
$ cd $GOPATH/src/github.com/JinCoin/jinwallet/cmd/dropwtxmgr
$ go get
```
...
```
$ dropwtxmgr
Database path: /home/username/.jinwallet/mainnet/wallet.db
Drop all jinwallet transaction history? [y/N] y
...
```
$ dropwtxmgr --db ~/.jinwallet/testnet/wallet.db
Database path: /home/username/.jinwallet/testnet/wallet.db
Drop all jinwallet transaction history? [y/N] y
Dropping wtxmgr namespace
```

After dropping transaction history, jinwallet may be restarted and a full rescan
